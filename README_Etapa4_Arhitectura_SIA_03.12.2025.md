...
**Student:** Stupu Rares-Andrei  
**Link Repository GitHub** https://github.com/StupuRares/Constatare-daune-autoturisme-BMW/blob/main/README.md
**Data:** 12.04.2025 
---
...
| Detectarea automata a unor lovituri pe masina | Clasificare imagine →  Identificare zonei loviturii cu 80% acuratete | RN + Web Service|
| Detectarea automata a pieselor lovite | Clasificare imagine → Detectarea loviturii si costul reparatiei| RN + Web Service |
